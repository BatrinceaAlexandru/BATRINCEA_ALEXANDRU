...
public class Main {
    public static void main ( String[] args ) {
        ...
        try {
            ...
            if (lines.isEmpty()) {
                System.out.println("No information in this file.");
                return;
            }
            ...
            results.add("Average score: " + averageScore);
            results.add("The youngest man: " + names.get(youngestIndex) + " (age: " + ages.get(youngestIndex) + ")");
            results.add("The oldest man: " + names.get(oldestIndex) + " (age: " + ages.get(oldestIndex) + ")");
